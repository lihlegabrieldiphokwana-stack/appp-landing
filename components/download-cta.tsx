        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              href="#"
              className="flex items-center gap-3 px-8 py-4 bg-white hover:bg-gray-100 text-black font-medium rounded-full transition-colors min-w-[200px] justify-center"
            >
          ...
          <p className="text-gray-500 text-sm">
            Free to download • No credit card required • 14-day free trial
          </p>
        </motion.div>
      </div>
    </section>
