        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-500 hover:text-white transition-colors text-sm">Download</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-500 hover:text-white transition-colors text-sm">GDPR</a></li>
            </ul>
          </div>
        </div>
