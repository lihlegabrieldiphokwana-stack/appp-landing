...
const SITUATIONS = [
  {
    id: "hair_braids",
    tabTitle: "Hair Styling & Braids",
    icon: Scissors,
    badge: "Mobile & Studio Stylists",
    title: "Knotless braids, lace wig installs & protective hair styling at home.",
    description:
      "Skip waiting 5 hours in a crowded salon chair. Book verified mobile hair stylists on Bouul who bring portable washing basins, hair extensions, and professional styling equipment directly to your living room.",
    timeline: "2 - 5 Hours",
    costEstimate: "R450 – R1,200",
    keyBenefits: [
      "Knotless braids, bohemian locs, stitch braids & lace wig installation",
      "Option to book mobile stylists for comfortable home service",
      "Verified real portfolio photos before locking in your appointment",
    ],
    ctaText: "Book Hair Stylist",
  },
  {
    id: "nails",
    tabTitle: "Nails & Lash Extensions",
    icon: Sparkles,
    badge: "Sanitized Hygiene Verified",
    title: "Gelish manicures, acrylic extensions & volume lash sets at home.",
    description:
      "Enjoy salon-grade nail art and full lash extensions without traveling across town. Vetted nail technicians bring UV LED lamps, sterilized tools, and high-quality gel polishes straight to your doorstep.",
    timeline: "1 - 2 Hours",
    costEstimate: "R350 – R850",
    keyBenefits: [
      "Gelish, rubber base, acrylic overlay & custom nail art",
      "Classic, hybrid & volume lash extensions with sensitive-eye adhesives",
      "Strict instrument sterilization & single-use file sanitation protocols",
    ],
    ctaText: "Book Nail Tech",
  },
  {
    id: "makeup",
    tabTitle: "Bridal & Glam Makeup",
    icon: Palette,
    badge: "HD Camera Ready",
    title: "Picture-perfect makeup artistry for weddings, matric dances & galas.",
    description:
      "Look radiant for your most important milestones. Book certified makeup artists on Bouul specializing in HD long-wear foundation, contouring, lash application, and touch-up kits for brides and matric dance attendees.",
    timeline: "1 - 2 Hours",
    costEstimate: "R650 – R1,600",
    keyBenefits: [
      "HD water-resistant airbrush & traditional glam makeup",
      "On-site bridal party group bookings with trial session options",
      "Includes premium strip lashes & touch-up lip kit",
    ],
    ctaText: "Book Makeup Artist",
  },
  {
    id: "barber",
    tabTitle: "Mobile Barbering & Grooming",
    icon: Sparkle,
    badge: "Executive Home Grooming",
    title: "Precision skin fades, beard sculpting & hot towel shaves at home or office.",
    description:
      "Reclaim your weekend hours with executive mobile barbering. Vetted master barbers arrive equipped with ring lights, cordless clippers, and hot towels to deliver crisp skin fades and beard line-ups in private.",
    timeline: "45 - 60 Mins",
    costEstimate: "R250 – R480",
    keyBenefits: [
      "Skin fades, taper cuts, razor line-ups & beard oil treatment",
      "Mobile barbers equipped for home or corporate office visits",
      "Strict blade hygiene with fresh disposable razor blades per client",
    ],
...
const PRICE_ESTIMATES = [
  {
    task: "Knotless Braids & Protective Hair Styling",
    range: "R450 - R950",
    time: "3 - 5 hours",
    desc: "Mobile braid installation including hair preparation, parting, and lightweight tension-free knotless technique.",
    includes: ["Hair prep & parting", "Knotless braiding", "Edging & oil sheen"],
  },
  {
    task: "Mobile Gelish Manicure & Luxury Pedicure",
    range: "R380 - R750",
    time: "1 - 2 hours",
    desc: "Cuticle care, nail shaping, gelish polish application with UV curing, and foot scrub massage.",
    includes: ["Nail shaping", "Gelish polish cure", "Foot scrub & massage"],
  },
  {
    task: "Bridal & Special Event Full Glam Makeup",
    range: "R650 - R1,400",
    time: "1 - 2 hours",
    desc: "HD camera-ready makeup artistry including skin prep, contouring, eye glam, and mink lash application.",
    includes: ["Skin prep & prime", "Full glam makeup", "Mink strip lashes"],
  },
  {
    task: "Mobile Gentleman's Fade & Beard Sculpting",
    range: "R250 - R480",
    time: "45 - 60 mins",
    desc: "Precision haircut fade, hot towel beard treatment, razor line-up, and styling pomade application.",
    includes: ["Precision fade cut", "Hot towel beard sculpt", "Fresh razor line-up"],
  },
];
    ...
    <main className="min-h-screen bg-b-paper font-sans text-b-ink antialiased">
      ...
      <section className="relative overflow-hidden bg-b-paper px-5 pb-20 pt-32 md:pt-40 border-b border-b-line">
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <span>Verified Mobile Stylists &amp; Barbers Available Now • Avg. Confirmation: 5 Mins</span>
          </motion.div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            >
              ...
              <p className="mt-6 max-w-lg text-lg leading-relaxed text-b-ink-soft">
                From knotless braids and acrylic nails to bridal makeup and mobile barbering. Book verified beauty professionals with real photo portfolios, upfront rates, and digital escrow safety.
              </p>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                ...
                >
                  ...
                  <span>Book Vetted Beauty Pro</span>
                </Link>
              ...
              <div className="mt-10 flex flex-wrap items-center gap-6 text-xs font-medium text-b-ink-faint border-t border-b-line pt-6">
                <div className="flex items-center gap-2">
                  ...
                  <span>100% Verified Real Photo Portfolios</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>4.99 Rating (6,400+ Bookings)</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center justify-between pb-4 border-b border-b-line mb-5">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-display font-bold text-sm">Mobile Stylist Matched</span>
                </div>
                <span className="text-xs font-semibold text-b-green-deep bg-b-green/10 px-2.5 py-1 rounded-full">
                  Hygiene &amp; Portfolio Verified
                </span>
              </div>
              ...
              <div className="rounded-2xl border border-b-green/30 bg-gradient-to-br from-b-green/10 via-transparent to-transparent p-4 mb-4">
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        <h4 className="font-display font-bold text-base text-b-ink">GlamCraft Studio</h4>
                        <CheckCircle2 className="h-4 w-4 text-emerald-600 fill-emerald-100" />
                      </div>
                      <p className="text-xs text-b-ink-soft">Mobile Braid &amp; Makeup Master • 6 Yrs Exp</p>
                    </div>
                  </div>
                  <div className="text-right">
                    ...
                    <span className="text-[10px] text-b-ink-faint">520+ Home Appointments</span>
                  </div>
                </div>

                <div className="mt-4 grid grid-cols-2 gap-2 text-xs">
                  <div className="rounded-xl bg-b-paper p-2.5 border border-b-line">
                    <span className="text-[10px] text-b-ink-faint block">Appointment Slot</span>
                    <span className="font-semibold text-emerald-600 flex items-center gap-1">
                      <Clock className="h-3 w-3" /> Saturday 10:00 AM
                    </span>
                  </div>
                  <div className="rounded-xl bg-b-paper p-2.5 border border-b-line">
                    <span className="text-[10px] text-b-ink-faint block">Escrow Protected</span>
                    <span className="font-semibold text-b-ink">R650.00 Held</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 pt-2">
                <div className="flex items-center gap-3 text-xs">
                  ...
                  <span className="text-b-ink font-medium">Send inspiration photo or choose style in app</span>
                </div>
                <div className="flex items-center gap-3 text-xs">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-emerald-600 text-white font-bold text-[10px]">
                    2
                  </div>
                  <span className="text-b-ink font-medium">Digital escrow holds payment safely until styling finishes</span>
                </div>
                <div className="flex items-center gap-3 text-xs">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-b-line text-b-ink-faint font-bold text-[10px]">
                    3
                  </div>
                  <span className="text-b-ink-faint">Inspect style &amp; tap 'Job Satisfied' to release funds</span>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section id="use-cases" className="py-24 px-5 max-w-6xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest text-emerald-600 bg-emerald-500/10 px-3 py-1 rounded-full mb-3">
            ...
            <span>Tailored Beauty Solutions</span>
          </div>
          <h2 className="font-display text-4xl md:text-5xl font-extrabold tracking-tight text-b-ink">
            How Bouul solves your exact beauty needs.
          </h2>
          <p className="mt-4 text-lg text-b-ink-soft">
            Select your scenario below to see how our vetted beauty professionals deliver salon-grade results in complete comfort.
          </p>
        </div>
              ...
              <div className="lg:col-span-5">
                <div className="rounded-2xl border border-b-line bg-b-paper p-6 space-y-6 shadow-sm">
                  <div className="border-b border-b-line pb-4">
                    <span className="text-xs font-semibold text-b-ink-faint uppercase tracking-wider">Estimated Duration &amp; Rate</span>
                  ...
                  <div className="space-y-3 text-xs text-b-ink-soft">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-b-ink">100% Real Client Photos</span>
                    </div>
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-b-ink">In-App Photo Consultation</span>
                    </div>
                  </div>
                  ...
                  <div className="p-3.5 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-xs text-emerald-950 flex items-start gap-2.5">
                    ...
                    <span>Every beauty pro on Bouul is identity verified and background cleared for safe, comfortable home entry.</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid gap-12 lg:grid-cols-12 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest text-amber-600 bg-amber-500/10 px-3 py-1 rounded-full">
                ...
                <span>Transparent Beauty Pricing</span>
              </div>

              <h2 className="font-display text-4xl font-extrabold tracking-tight text-b-ink leading-tight">
                No hidden add-ons. Upfront style pricing.
              </h2>

              <p className="text-base leading-relaxed text-b-ink-soft">
                Know what your hairstyle, lash set, or makeup glam will cost before your appointment starts. Bouul standardizes baseline pricing so there are no surprise fees for wash or lashes.
              </p>
              ...
              <div className="p-5 rounded-2xl bg-b-paper border border-b-line space-y-3">
                <div className="flex items-center gap-2 font-display font-bold text-sm text-b-ink">
                  <ShieldCheck className="h-4 w-4 text-emerald-600" />
                  <span>The Bouul Satisfaction Guarantee</span>
                </div>
                <p className="text-xs text-b-ink-soft leading-relaxed">
                  Your stylist completes your look according to your agreed photo inspiration. Escrow is held safely until you inspect your style in the mirror and tap &apos;Job Satisfied&apos;.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-7">
              <div className="rounded-3xl border border-b-line bg-b-paper p-6 md:p-8 shadow-xl space-y-6">
                <div className="flex items-center justify-between border-b border-b-line pb-4">
                  <span className="font-display font-bold text-lg text-b-ink">Select Treatment for Guide Pricing</span>
                ...
                <div className="pt-2 flex items-center justify-between">
                  ...
                  >
                    <span>Book Appointment In App</span>
      ...
      <section className="bg-b-forest py-24 px-5 text-b-cream relative overflow-hidden border-t border-b border-b-forest-line">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid gap-12 lg:grid-cols-12 items-center">
            {/* Left Column: Explaining Zola AI in the context of beauty */}
            <div className="lg:col-span-6 space-y-6">
              ...
              <h2 className="font-display text-4xl md:text-5xl font-extrabold tracking-tight text-white leading-tight">
                Meet Zola. Your AI beauty assistant who matches inspiration photos.
              </h2>
              
              <p className="text-lg text-b-cream/80 leading-relaxed">
                Send Zola a Pinterest or Instagram photo of the hairstyle or makeup glam you want—she matches you with top-rated mobile stylists who specialize in that exact technique.
              </p>
              ...
              <div className="space-y-4 pt-2">
                <div className="p-4 rounded-2xl bg-b-forest-raised border border-b-forest-line flex items-start gap-3.5 shadow-sm">
                  ...
                  <div>
                    <h3 className="font-display font-bold text-base text-white">Visual Inspiration Photo Matching</h3>
                    <p className="mt-1 text-xs leading-relaxed text-b-cream/70">
                      Upload an Instagram hair braid or makeup inspiration photo. Zola&apos;s vision AI analyzes braid pattern, length, and makeup tones, recommending verified stylists with matching portfolio work.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-b-forest-raised border border-b-forest-line flex items-start gap-3.5 shadow-sm">
                  ...
                  <div>
                    <h3 className="font-display font-bold text-base text-white">Hair &amp; Beauty Memory Profile</h3>
                    <p className="mt-1 text-xs leading-relaxed text-b-cream/70">
                      Zola remembers your hair length, texture preferences, skin undertones, and acrylic vs gel preferences. She briefs your stylist before every appointment so your service is personalized.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-2xl bg-b-forest-raised border border-b-forest-line flex items-start gap-3.5 shadow-sm">
                  ...
                  <div>
                    <h3 className="font-display font-bold text-base text-white">Instant Calendar &amp; Group Booking</h3>
                    <p className="mt-1 text-xs leading-relaxed text-b-cream/70">
                      Planning a wedding or group matric dance preparation? Zola coordinates multi-stylist schedules simultaneously so your entire bridal party gets glam together on time.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {/* Right Column: Zola Beauty Chat Mockup */}
              ...
              <div className="rounded-3xl border border-b-forest-line bg-b-forest-raised p-6 md:p-8 shadow-[0_24px_60px_rgba(0,0,0,0.4)] relative">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="rounded-full bg-emerald-500/20 border border-emerald-500/30 px-2.5 py-0.5 text-[10px] font-bold text-emerald-400">
                          Vision &amp; Style Memory Active
                        </span>
                      </div>
                      <p className="text-[11px] text-b-cream/60">Zone of Local Assistance • Mobile Beauty Dispatch</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <div className="ml-auto w-fit max-w-[88%] rounded-2xl rounded-br-sm bg-emerald-600 px-4 py-3 text-sm text-white shadow-sm">
                    <p className="mb-2">I want this exact knotless braid style for Saturday! Here is my inspiration photo:</p>
                    <div className="rounded-xl bg-b-ink/40 p-2.5 border border-white/10 flex items-center gap-3">
                      ...
                      <div className="text-xs">
                        <p className="font-semibold text-white">boho_knotless_braids.jpg</p>
                        <p className="text-[10px] text-emerald-200">Vision Analysis: Waist-Length Bohemian Knotless</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-fit max-w-[92%] rounded-2xl rounded-bl-sm bg-b-forest border border-b-forest-line px-4 py-3.5 text-sm text-b-cream shadow-sm space-y-2.5">
                    <div className="flex items-center gap-1.5 text-xs font-semibold text-b-sun">
                      <Sparkles className="h-3.5 w-3.5" />
                      <span>Zola Style &amp; Portfolio Match</span>
                    </div>
                    <p className="text-xs leading-relaxed text-b-cream/90">
                      I analysed your inspiration photo: waist-length bohemian knotless braids with curls. From your **Beauty Memory**, I noted your preference for lightweight 1B synthetic extension hair.
                    </p>
                    <p className="text-xs leading-relaxed text-b-cream/90">
                      I matched **GlamCraft Studio** (4.99 ★, 520+ home braids) who has identical portfolio photos and an opening Saturday at 10:00 AM.
                    </p>
                  </div>
                  ...
                  <div className="w-fit max-w-[92%] rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-950/40 to-b-forest p-4 space-y-3">
                    ...
                    <div>
                      <p className="text-sm font-bold text-white">Bohemian Knotless Braids (Mobile Home Visit)</p>
                      <p className="text-xs text-b-cream/70 mt-0.5">GlamCraft Studio • Sat 10:00 AM • Fixed R650</p>
                    </div>
                    <div className="pt-2 flex items-center gap-3">
                      ...
                      <span className="text-[11px] text-b-cream/50">100% satisfaction guarantee</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* ── 5. DEEP-DIVE FEATURE SPOTLIGHT: The Architecture of Beauty Trust ── */}
      <section className="py-24 px-5 max-w-6xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest text-emerald-600 bg-emerald-500/10 px-3 py-1 rounded-full mb-3">
            <ShieldCheck className="h-3.5 w-3.5" />
            <span>Built For Beauty Confidence</span>
          </div>
          <h2 className="font-display text-4xl md:text-5xl font-extrabold tracking-tight text-b-ink">
            Why booking beauty on Bouul is fundamentally superior.
          </h2>
          <p className="mt-4 text-lg text-b-ink-soft">
            Your hair and appearance are deeply personal. We engineered a platform enforcing verified client portfolios, digital escrow, and strict hygiene vetting.
          </p>
        </div>
          ...
          {[
            {
              ...
              title: "1. 100% Real Photo Portfolios",
              subtitle: "No stolen internet stock images",
              body: "Every portfolio photo on Bouul is verified from real client appointments. What you see on a stylist's profile is the exact quality you receive.",
            },
            {
              icon: Lock,
              color: "bg-amber-500/10 text-amber-600",
              title: "2. The Digital Escrow Shield",
              subtitle: "Pay only after inspecting your style",
              body: "Never pay upfront deposits to unverified Instagram accounts. Your funds are locked safely in Bouul escrow and only released when you inspect your style in the mirror.",
            },
            {
              icon: Sparkles,
              color: "bg-emerald-500/10 text-emerald-600",
              title: "3. Sanitized Mobile Equipment",
              subtitle: "Clean, hygienic home appointments",
              body: "Mobile beauty pros on Bouul bring sterilized tools, disposable blade razors, UV lamps, and ring lights to deliver a professional salon experience in your home.",
            },
          ].map((feat, i) => (
            <motion.div
              key={feat.title}
            ...
            >
              ...
              <div className="mt-8 pt-4 border-t border-b-line/80 flex items-center gap-2 text-xs font-semibold text-emerald-600">
                <span>Standard on all beauty bookings</span>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest text-b-sun bg-b-sun/10 px-3 py-1 rounded-full mb-3">
              ...
              <span>Proven Bridal Glam Transformation</span>
            </div>
            <h2 className="font-display text-4xl md:text-5xl font-extrabold tracking-tight text-white">
              From inspiration photo to picture-perfect aisle prep.
            </h2>
            <p className="mt-4 text-lg text-b-cream/80">
              See how a wedding morning bridal hair &amp; makeup booking was executed flawlessly on site at a venue.
            </p>
          </div>
            ...
            {[
              {
                ...
                time: "07:00 AM",
                title: "Inspiration Photo Upload",
                desc: "Bride sends Pinterest glam photo in Bouul app. Escrow locks agreed fixed rate.",
                badge: "Photo Brief Saved",
              },
              {
                step: "02. Setup",
                time: "07:30 AM",
                title: "Mobile Glam Station Setup",
                desc: "Stylist arrives at venue suite with ring light, airbrush foundation, and hot tools.",
                badge: "On-Site Arrival",
              },
              {
                step: "03. Execution",
                time: "09:00 AM",
                title: "HD Makeup & Hair Styling",
                desc: "HD foundation applied, lash extension fitment, and hollywood waves styled.",
                badge: "Photo Inspection",
              },
              {
                step: "04. Final Touch",
                time: "09:45 AM",
                title: "Mirror Inspection & Approval",
                desc: "Bride inspects look, receives touch-up lipstick kit, and taps 'Satisfied' to release funds.",
      ...
      {/* ── 7. BEAUTY PROS IN ACTION — VERIFIED FIELD IMAGERY ── */}
      <section className="py-24 px-5 max-w-6xl mx-auto border-b border-b-line">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-extrabold tracking-tight text-b-ink">
            Professional beauty standards, showcased in-app.
          </h2>
          <p className="mt-4 text-lg text-b-ink-soft">
            Every beauty pro on Bouul is vetted for skill and hygiene. Here is a glimpse of the professional standards and capabilities available when you book through the app.
          </p>
        </div>
      ...
      {/* ── 8. COMPREHENSIVE BEAUTY SERVICES DIRECTORY ── */}
      <section className="py-24 px-5 max-w-6xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="font-display text-4xl md:text-5xl font-extrabold tracking-tight text-b-ink">
            Every beauty service, covered and verified.
          </h2>
          <p className="mt-4 text-lg text-b-ink-soft">
            From mobile braiding and manicures to event makeup and executive barbering.
          </p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            {
              category: "💇‍♀️ Hair & Braids",
              items: [
                "Knotless braids & bohemian locs",
                "Stitch braids & cornrows styling",
                "Lace wig installation & customization",
                "Dreadlocks retwist & interlocking",
                "Silk press & blowout treatments",
                "Mobile hair wash & deep conditioning",
              ],
            },
            {
              category: "💅 Nails & Lash Extensions",
              items: [
                "Gelish manicure & spa pedicure",
                "Acrylic nail extension overlays",
                "Classic 1:1 lash extension sets",
                "Volume & hybrid fluffy lash sets",
                "Eyebrow threading & tinting",
                "Lash lift & keratin tint treatments",
              ],
            },
            {
              category: "💄 Makeup & Barbering",
              items: [
                "Bridal full glam makeup artistry",
                "Matric dance & event makeup",
                "Mobile skin fade & taper haircut",
                "Hot towel beard sculpt & razor line-up",
                "Mobile deep tissue & Swedish massage",
                "Hydrating facial & skin extraction",
              ],
            },
          ].map((col) => (
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl font-extrabold tracking-tight text-b-ink">
              Frequently asked questions about booking beauty pros.
            </h2>
          </div>
          ...
          <div className="space-y-4">
            {[
              {
                q: "Do I need to buy my own braiding hair extensions?",
                a: "You can specify during booking whether you'll provide your own extension hair or if you'd like your stylist to supply pre-stretched braiding hair in your desired color.",
              },
              {
                q: "What if load shedding happens during my hair or nail appointment?",
                a: "All mobile pros on Bouul bring battery-operated LED ring lights and cordless hair tools or UV lamps so your appointment proceeds smoothly without interruption.",
              },
              {
                q: "How does Bouul verify stylist portfolios?",
                a: "Stylists must upload raw client photos directly from completed bookings. Stolen internet stock photos are flagged and removed by our verification team.",
              },
              {
                q: "Can I book a trial makeup session before my wedding?",
                a: "Yes! You can book a discounted trial makeup session with your chosen artist to test foundation shade matching and eye glam before the big wedding day.",
              },
              {
                q: "When is my payment released to the beauty pro?",
                a: "Your payment is locked safely in Bouul escrow and is only released after you inspect your completed style in the mirror and tap 'Job Satisfied'.",
              },
            ].map((faq, i) => (
              <motion.div
                key={faq.q}
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 px-4 py-1.5 text-xs font-bold text-emerald-600 uppercase tracking-widest">
              <Sparkles className="h-3.5 w-3.5" />
              <span>Verified Beauty Dispatch</span>
            </div>

            <h2 className="font-display text-4xl md:text-5xl font-extrabold tracking-tight text-b-ink">
              Ready for flawless hair, nails, or makeup?
            </h2>

            <p className="max-w-xl mx-auto text-lg text-b-ink-soft leading-relaxed">
              Never stress over unverified Instagram accounts or salon queues again. Join thousands who use Bouul to book vetted, escrow-protected beauty pros in seconds.
            </p>
